...
<body class="cbp-spmenu-push">
    ...
    <div class="container" id="home">
        <div class="row text-center">
            <div class="col-md-12">
                <span class="head-main">Nur Ashar WEB</span>
                <h2 class="head-sub-main">Tugas Laporan Praktikum Jaringan Komputer dan Multimedia</h2>
                <h3 class="head-last">Nur Ashar Aditiya</h3>
		<h3 class="head-last">3110131050</h3>
		<h3 class="head-last">3 Mechatronic B</h3>
                <a href="#about-sec" class="btn btn-danger btn-lg head-btn-one">EXPLORE AXIS</a> &nbsp;  <a href="#about-sec" class="btn btn-primary btn-lg">MODEL 
